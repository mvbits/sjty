...
public class Notification extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        if (action.equals("beep")) {
            ...
            this.confirm(args.getString(0), args.getString(1), callbackContext);
            return true;
        }
     ...
     * @param callbackContext   The callback context.
     */
    public  void confirm( final String message,  final String title,  final CallbackContext callbackContext) {
    
    	Log.i("lwj", "canbehehe?");
     
    		//	Builder dlg = new AlertDialog.Builder(this.cordova.getActivity()); // new AlertDialog.Builder(cordova.getActivity(), AlertDialog.THEME_DEVICE_DEFAULT_LIGHT);
    			Builder dlg =  new AlertDialog.Builder(cordova.getActivity(), AlertDialog.THEME_HOLO_LIGHT);
    			dlg.setMessage(message);
                dlg.setTitle(title);
                dlg.setCancelable(true);//可以被返回键关闭

                dlg.setNeutralButton("取消",
                        new AlertDialog.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                dialog.dismiss();
                                callbackContext.sendPluginResult(new PluginResult(PluginResult.Status.OK, 0));
