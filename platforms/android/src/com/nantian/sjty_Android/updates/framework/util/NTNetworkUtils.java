package com.nantian.sjty_Android.updates.framework.util;
...
import com.nantian.sjty_Android.updates.framework.NTConstants.Spec;
import com.nantian.sjty_Android.updates.framework.exception.NTServiceException;
import com.nantian.sjty_Android.updates.framework.exception.NTServiceSecurityException;
import com.nantian.sjty_Android.updates.framework.util.NTNetworkUtils.HttpRequest.Method;
import com.nantian.sjty_Android.updates.framework.util.NTNetworkUtils.HttpRequest.Parameter;
...
public class NTNetworkUtils {
	...
	public static HttpResponse send(HttpRequest request) throws Exception {
		...
		try {
			...
			throw new NTServiceException(com.nantian.sjty_Android.updates.framework.NTConstants.Error.NETWORK_ERROR, se);
			...
			NTLogger.error(TAG, "Failed to send request", e);
			throw new NTServiceException(com.nantian.sjty_Android.updates.framework.NTConstants.Error.SYSTEM_ERROR, e);
		} finally {
			disconnect();
		}
	}
